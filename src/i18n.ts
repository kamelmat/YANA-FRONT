          ...
          playlist: {
            items: [
              ...
              },
              {
                ...
                description:
                  "An exquisite musical selection produced with Tibetan bowls.",
              },
              {
        ...
        resources: {
          ...
          playlist: {
            items: [
              {
                title:
                  "Manos enlazadas. Canciones para conectar con tu entorno.",
                description:
              ...
              },
              {
                ...
                description:
                  "Una experiencia auditiva relajante para conciliar el sueño.",
              },
              {
